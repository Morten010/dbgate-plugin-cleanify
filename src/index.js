const theme = {
    themeName: 'dbgate-plugin-cleanify',
    themeType: 'dark',
    themeClassName: 'theme-dbgate-plugin-cleanify',
    themeCss: `     
  .theme-dbgate-plugin-cleanify {  
    --theme-font-1: #e3e3e3;
    --theme-font-2: #b5b5b5;
    --theme-font-3: #888888;
    --theme-font-4: #5a5a5a;
    ...
    --theme-icon-red: #e24e44;
    --theme-icon-gold: #facc15;
